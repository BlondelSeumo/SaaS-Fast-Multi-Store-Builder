...
class IndexController extends Controller{
    ...
    */
    ...
    public function pages(){
        # get all category
        $pages = Pages_Category::leftJoin('pages', 'pages.category', '=', 'pages_categories.id')
    ...
    public function index(Track $track){
        ...
        $packages = Packages::where('status', 1)->limit(1)->get();
        # view page
        return view('index.index', ['packages' => $packages, 'greeting' => $greeting, 'demo_user' => $demo_user]);
    }
