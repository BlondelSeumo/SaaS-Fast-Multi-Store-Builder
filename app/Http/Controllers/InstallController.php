...
$https = '<IfModule mod_rewrite.c>
    ...
    public function migration(Request $request){
        ...
        try {
            $new_user           = new User;
            $new_user->name     = ['first_name' => $first_name, 'last_name' => $last_name];
    ...
    public function appDetailSubmit(Request $request) {
        ...
        unset($requests['_token'], $requests['force_https'], $requests['first_name'], $requests['last_name'], $requests['email'], $requests['username'], $requests['password'], $requests['password_confirmation']);
