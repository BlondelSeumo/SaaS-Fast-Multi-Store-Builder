...
<div class="nk-block-head mt-8">
    <div class="nk-block-between-md g-4">
        <div class="nk-block-head-content">
            <h2 class="nk-block-title fw-normal">{{ __('Domains') }}</h2>
        </div>
        <div class="nk-block-head-content">
            <a href="{{ route('user-domains-post') }}" class="btn btn-primary"><em class="icon ni ni-plus"></em> {{ __('Add new domain') }}</a>
        </div>
    </div>
</div>
...
<div class="nk-block">
   <div class="nk-tb-list is-separate is-medium mb-3">
      ...
      <div class="nk-tb-item background-lighter">
         ...
         <div class="nk-tb-col background-lighter">
            <span class="dot d-md-none {{$item->status == 0 ? ' badge-warning' : NULL }} {{$item->status == 1 ? ' badge-success' : NULL }} {{$item->status == 2 ? ' badge-danger' : NULL }}"></span>
         ...
         <div class="nk-tb-col background-lighter">
            <span class="tb-lead"><a href="{{ route('user-domains-post', ['id' => $item->id]) }}" class="btn btn-primary">{{ __('Edit') }}</a></span>
        </div>
         <div class="nk-tb-col background-lighter">
